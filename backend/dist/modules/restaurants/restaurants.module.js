...
const restaurant_schema_2 = require("./schemas/restaurant.schema");
...
exports.RestaurantsModule = RestaurantsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: restaurant_schema_2.Restaurant.name, schema: restaurant_schema_1.RestaurantSchema }])],
