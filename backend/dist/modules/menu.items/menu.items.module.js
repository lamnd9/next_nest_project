...
const menu_item_schema_2 = require("./schemas/menu.item.schema");
...
exports.MenuItemsModule = MenuItemsModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: menu_item_schema_1.MenuItem.name, schema: menu_item_schema_2.MenuItemSchema }])],
