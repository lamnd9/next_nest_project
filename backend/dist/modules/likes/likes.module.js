...
const like_schema_2 = require("./schemas/like.schema");
...
exports.LikesModule = LikesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: like_schema_1.Like.name, schema: like_schema_2.LikeSchema }])],
