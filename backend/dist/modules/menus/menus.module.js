...
const menu_schema_2 = require("./schemas/menu.schema");
...
exports.MenusModule = MenusModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: menu_schema_2.Menu.name, schema: menu_schema_1.MenuSchema }])],
